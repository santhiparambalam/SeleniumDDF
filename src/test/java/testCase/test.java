...
//ADD ADDRESS(add multiple address)
...
//Step 27:Click sign out
	public static void main(String[] args)
	{
		...
		String navigationpage=driver.findElement(By.cssSelector("span[class='navigation_page']")).getText();
		if(navigationpage.equalsIgnoreCase("My Account")){
			System.out.println("Navigation button is My account");
		}
		
		driver.findElement(By.cssSelector("a[href='http://automationpractice.com/index.php?controller=history']"));
		driver.findElement(By.cssSelector("a[href='http://automationpractice.com/index.php?controller=order-slip']"));
		driver.findElement(By.cssSelector("a[href='http://automationpractice.com/index.php?controller=identity']"));
		driver.findElement(By.cssSelector("a[href='http://automationpractice.com/index.php?fc=module&module=blockwishlist&controller=mywishlist']"));
		...
		driver.findElement(By.cssSelector("input[name='alias']")).click();
